...
@section('content')
    ...
    @foreach($all_posts as $post)
        <li class="list-group-item d-flex align-items-center">
            ...
            {{-- <a href="" class="text-danger float-end mx-1" onclick="return  confirm('do you want to delete')"><i class="fas fa-trash"></i></a>
            <a href="" class="text-info float-end mx-1"><i class="fas fa-edit"></i></a> --}}
        </li>
    @endforeach
    <div class="mt-2">{{ $all_posts->onEachSide(10)->links() }}</div>
    </ul>
