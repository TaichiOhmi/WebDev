...
@section('content')
    <form action="#" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#getCurrentLocation" onclick="initMap()">
              Get Location
            </button>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?language=ja&region=JP&key=key" async defer>
    </script>
@endsection
