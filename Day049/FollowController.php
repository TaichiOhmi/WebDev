...
class FollowController extends Controller
{
    ...
    {
        // $followers = $this->follow->where('following_id', '=', $id);
        $followers = $this->follow->where('following_id', '=', $id)->get();
        return view('users.profile.followers')->with('followers', $followers);
    }
