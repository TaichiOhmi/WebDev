...
<?php
    ...
    if(isset($_POST['btn_newPost'])){
        ...
        function Post($conn, $title, $message, $category, $date, $user){
            $sql = "INSERT INTO posts(`post_title`, `date_posted`, `category_id`, `post_message`, `accout_id`) VALUES ('$title', '$date', $category, '$message', $user)";
        ...
        Post($conn, $title, $message, $category, $date, $user);
    }
?>
<body class=" bg-info">
