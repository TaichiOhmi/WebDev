...
class PostController extends Controller
{
    ...
    public function __construct(Post $post_m)// $post_m = new Post ※ laravel can understand that syntax
    {
        $this->post_m = $post_m;
    }
    ...
    public function showOwner($post_id)
    {
        // $post_title = $this->post_m->find($post_id)->title;
        // $post_content = $this->post_m->find($post_id)->content;
        $user = $this->post_m->find($post_id)->user; // Post Model user() method

        return "Post ID: $post_id<br>Owner: $user->name<br>";
    }
