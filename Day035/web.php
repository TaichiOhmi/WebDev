...
Route::get('/read-paginate', [PostController::class, 'indexPaginate']);
Route::get('/destroy/{post_id}', [PostController::class, ('destroy')]);



Route::get('/show-phone/{user_id}', [UserController::class, ('showPhone')]);
Route::get('/show-user/{phone_id}', [PhoneController::class, ('showUser')]);
Route::get('/show-posts/{user_id}', [UserController::class, ('showPosts')]);
Route::get('/show-owner/{post_id}', [PostController::class, ('showOwner')]);